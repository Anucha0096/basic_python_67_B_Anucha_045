...
this_list7.sort()               # เรียงอักษรตาม อัลฟาเบ็ท
print(this_list7, len(this_list7))

this_list8 = ["orange", "mango", "kiwi", "pineapple", "banana"]
this_list8.reverse()            # เรียงเอาหลังมาไว้หน้า
...
this_tuple = ("apple", "banana", "cocomut")
print(this_tuple)
...
this_tuple2 = ("apple", "banana", "cocomut")
...
this_tuple5 = ("apple", "banana", "cocomut")
...
this_tuple8 = ("apple", "banana", "cocomut")
...
#del this_tuple8
#print(this_tuple8, type(this_tuple8)) #ไม่เหลืออะไรเลย
...
for x in this_set: # แสดงทีละบรรทัด
    print(x)
...
this_set8.clear()               # เหลือแต่ตข้อมูล
print(this_set8, type(this_set8 ))
del this_set8                   # ลบตัวแปรไปเลย
#print(this_set8, type(this_set8 ))
...
print(my_car["car2"]["model"]) #แสดง car2 ส่วนของ model